...
image: '/static/images/dynamic-comments-for-a-static-website/cover.jpg'
---

<div className="my-10">
  <Image
    alt={`Cover`}
    src={`/static/images/dynamic-comments-for-a-static-website/cover.jpg`}
    width={1920 / 2}
    height={1080 / 2}
    priority
  />
...
Well, there’s a way around this limitation as well. stale-while-revalidate to the rescue! With a nice package from Vercel team called SWR you can do all sorts of magic. And here it all comes together:
