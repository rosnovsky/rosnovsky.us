...
image: '/static/images/weekly-update-3/cover.png'
---
...
<div className="my-10">
  <Image
    alt={`Elliot Bay`}
    src={`/static/images/weekly-update-2/elliot-bay.jpg`}
    width={1501 / 2}
    height={712 / 2}
    priority
  />
  <div className="text-sm text-center">Elliot Bay</div>
</div>

<div className="my-10">
  <Image
    alt={`Seattle Skyline`}
    src={`/static/images/weekly-update-2/seattle-skyline.jpg`}
    width={1501 / 2}
    height={712 / 2}
    priority
  />
  <div className="text-sm text-center">Seattle Skyline</div>
</div>

<div className="my-10">
  <Image
    alt={`Elliot Bay`}
    src={`/static/images/weekly-update-2/olympic-mountains.jpg`}
    width={1501 / 2}
    height={712 / 2}
    priority
  />
  <div className="text-sm text-center">Olympic Mountains</div>
</div>
