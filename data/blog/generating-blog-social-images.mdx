...
summary: "Since I launched my new blog, I discovered that social images were broken; they were an afterthought after all, and I decided to fix it permanently."
# category: 'Blog'
# tags: ['blog', 'house', 'family']
image: '/static/images/generating-blog-social-images/cover.jpg'
---

<div className="my-10">
  <Image
    alt={`Cover`}
    src={`/static/images/generating-blog-social-images/cover.jpg`}
    width={1920 / 2}
    height={1080 / 2}
    priority
  />
...
Here's an example: this link leads to the page that builds the social card.
...
<div className="m-0 flex w-full">
  <div
    className="relative border-1 bg-transparent w-full border-red-900 p-6" style={{
    ...
    <main className="flex-col p-5 bg-opacity-80 bg-white border-2 border-black">
      ...
      <div className="flex justify-between">
        <p className="prose prose-lg text-2xl text-red-900 font-semibold font
            -mono">
          {date || 'No date'}
        </p>
...
__UPDATE__: Well, apparently, it's more performant to add the URL to the serverless function directly to the meta tag after all. Sorry about the confusion :)
