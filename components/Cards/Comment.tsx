  ...
  return (
    <div className="my-10">
      <div className="w-full p-3 flex items-center justify-center">
        <div className={comment.flagged ? "bg-red-100 border border-red-800 shadow-sm mx-auto px-4 py-3 rounded-lg w-full" : "bg-white dark:bg-gray-900 border shadow-sm mx-auto px-4 py-3 rounded-lg w-full"}>
