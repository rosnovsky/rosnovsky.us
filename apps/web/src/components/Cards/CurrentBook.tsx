...
const bookIcon =  <svg role="img" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" aria-labelledby="bookOpenedIconTitle" stroke="rgb(20 184 166)" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" fill="none" color="rgb(20 184 166)"> <title id="bookOpenedIconTitle">Book</title> <path d="M12 6s-2-2-4-2-5 2-5 2v14s3-2 5-2 4 2 4 2c1.333-1.333 2.667-2 4-2 1.333 0 3 .667 5 2V6c-2-1.333-3.667-2-5-2-1.333 0-2.667.667-4 2z" /> <path stroke-linecap="round" d="M12 6v14" /> </svg>
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <div className="mx-auto pt-6">
        <Card className="flex flex-row space-y-4" as="div" key={currentBook.title}>
          ...
          <Image
            ...
            height={140}
            placeholder="blur"
            blurDataURL={currentBook.cover.metadata.lqip}
          />
            <div>
