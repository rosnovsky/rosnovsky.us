...
const mailIcon = <svg role="img" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" aria-labelledby="envelopeAltIconTitle" stroke="rgb(20 184 166)" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" fill="none" color="rgb(20 184 166)"> <title id="envelopeAltIconTitle">Envelope</title> <rect width="20" height="14" x="2" y="5" /> <path stroke-linecap="round" d="M2 5l10 9 10-9" /> </svg>
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex">
        ...
        <Button href="" onClick={(e) => handleSubscribe(e)} type="submit" className={`ml-4 flex-none ${success
          ? 'cursor-not-allowed'
          : ""
