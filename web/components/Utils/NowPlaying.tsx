...
const url =
  process.env.NOVE_ENV === 'test'
    ? 'https://rosnovsky.us/api/last-played'
    : '/api/last-played';
  ...
  return (
    <>
      <div className="flex justify-items-center flex-row w-full mt-2 mb-10">
        <span className="text-gray-800 -rotate-90 mt-3 font-bold font-mono text-xs dark:text-gray-200">
          Last&nbsp;Played
          <div className="justify-items-center h-3  flex flex-col">
            <svg
              version="1.1"
              id="Layer_1"
              ...
              className="text-black h-3 fill-current dark:text-white"
            >
              <path
                className="text-black h-3 fill-current dark:text-white"
