      ...
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
        ...
        <div className="mb-8">
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            This Stats page is work in progress. It&apos;s inspired by{' '}
            <a
            ...
            (as is the rest of the website), and I will customize it with my own
            points of data. Eventually :)
          </p>
        </div>
        <div className="flex flex-col w-full">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            These are the last 10 tracks I&apos;ve listened to on Apple Music.
            Don&apos;t judge!
          </p>
          <TopTracks />
          <SubscribeCard />
