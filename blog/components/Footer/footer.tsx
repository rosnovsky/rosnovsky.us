...
import { BlogPage, MenuItem } from '../..'

const Footer = ({ menuItems }: { menuItems: MenuItem[] }) => {
  return (
    <footer className="bg-accent-1 border-t border-accent-2">
      <div className="bg-white">
        <div className="max-w-7xl font-body mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
          <nav
          ...
          <p className="mt-8 text-center text-base text-gray-600">
            ...
            , and other{' '}
            <a
              href="https://en.wikipedia.org/wiki/Coast_Salish"
              title="Costal Salish People"
              target="_blank"
              rel="noreferer noopener"
            >
              Costal Salish
