...
const Header = ({ onHideNav, onShowNav, showNav, siteTitle }) => {
  ...
  <div className="relative bg-white shadow">
    ...
    <div className={`${isOn ? "visible" : "hidden"} absolute top-0 inset-x-0 z-10 p-2 transition transform origin-top-right md:hidden`}>
          ...
          <div className="py-6 px-5 space-y-6">
            <div className="space-y-6">
              ...
              <p className="text-center text-base leading-6 font-medium text-gray-500">
                Already a member? <br />
                <a href="#" className="text-orange-600 hover:text-orange-500 transition ease-in-out duration-150">
                  Sign in
                </a>
              </p>
            </div>
