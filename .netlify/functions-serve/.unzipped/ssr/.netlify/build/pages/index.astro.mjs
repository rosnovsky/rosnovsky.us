import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as renderComponent, f as addAttribute } from '../chunks/astro/server_DXCePE4i.mjs';
import 'kleur/colors';
import { a as $$Icon, $ as $$Container, b as $$Layout } from '../chunks/Layout_DlWymJ4s.mjs';
import 'clsx';
import { $ as $$Underline } from '../chunks/Underline_BN2I0gln.mjs';
import { jsxs, jsx } from 'react/jsx-runtime';
import { useState, useEffect } from 'react';
import { a as SOCIALS, t as typescript, S as SITE } from '../chunks/config_D8GI9YXN.mjs';
import { Picture as $$Picture, Image as $$Image } from '../chunks/_astro_assets_Be4H0COL.mjs';
import { $ as $$BlogGrid } from '../chunks/BlogGrid_SUjpUDJW.mjs';
import { g as getSortedPosts } from '../chunks/posts_Dw1-aoRv.mjs';
...
function LastPlayedSong() {
  ...
  if (!currentMusic) {
    return /* @__PURE__ */ jsxs("div", { className: "absolute left-12 top-full inline-flex h-12 w-max -translate-y-6 items-center justify-center gap-3.5 rounded-2xl bg-white/90 px-8 text-sm font-semibold text-slate-700 shadow-lg shadow-emerald-100/50 ring-1 ring-slate-900/5 backdrop-blur-md dark:bg-slate-950/30 dark:text-slate-400 dark:shadow-emerald-950/50 dark:ring-slate-100/5 md:left-0 md:-translate-x-20 md:-translate-y-24 lg:-left-3 lg:-translate-y-24 lg:px-10 xl:-left-6 xl:-translate-x-28 xl:-translate-y-32", children: [
      /* @__PURE__ */ jsx("img", { src: "/react.svg", alt: "", className: "h-6 w-auto", width: "16" }),
      "🔥🔥🔥"
    ] });
  }
  return /* @__PURE__ */ jsx(
